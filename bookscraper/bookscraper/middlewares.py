...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def _get_user_agents_list(self):
        """Retrieves a list of user agents from ScrapeOps.

        This method makes a GET request to the ScrapeOps user agent endpoint
        and returns a list of user agents. The list of user agents is stored
        in the 'user_agents_list' attribute of the class.

        The 'num_results' parameter can be used to limit the number of user
        agents returned. If not set, all user agents will be returned.
    ...
    def _get_random_user_agent(self):
        """
        Returns a random user agent string from the list of user agents
        retrieved from ScrapeOps.
        """
    ...
    def _scrapeops_fake_user_agents_enabled(self):
        """Determines if the Fake User Agent feature is enabled or not.

        It will be enabled if the SCRAPEOPS_API_KEY is set and the
        SCRAPEOPS_FAKE_USER_AGENTS_ENABLED setting is set to True.
        """
